...
const Navbar = () => {
  ...
  const NavLinks = () => (
    <ul className='flex lg:space-x-5 space-y-3 lg:space-y-0 lg:text-[16px] text-[#1d2549] text-[14px] lg:flex-row flex-col font-medium capitalize lg:text-white'>
      ...
      <li className='hover:text-[#bdf347] transition-all hover:scale-90'><NavLink>what we offer</NavLink></li>
      <li className='hover:text-[#bdf347] transition-all hover:scale-90'><NavLink>who we are</NavLink></li>
      <li className='hover:text-[#bdf347] transition-all hover:scale-90'><NavLink>insight</NavLink></li>
      <li className='hover:text-[#bdf347] transition-all hover:scale-90'><NavLink>careers</NavLink></li>
      <li className='hover:text-[#bdf347] transition-all hover:scale-90'><NavLink>contact</NavLink></li>
    </ul>
  );
  ...
  return (
    <>
      ...
      <header className='bg-gradient-to-r z-20  fixed top-0 left-0 w-full  from-[#1d2549] via-[#365200] to-[#1d2549] text-white py-5 lg:px-28 px-3 '>
        <div className='container mx-auto flex lg:justify-between items-center'>
          ...
          <nav className={`flex gap-y-8    ps-[1rem] py-[5rem] lg:ps-0 lg:py-0 z-20  w-[80%] sm:w-[30%]  lg:w-auto  h-screen overflow-auto lg:h-auto absolute lg:relative lg:top-auto lg:right-auto top-0 right-0 bg-[#bdf347] lg:bg-transparent  transition-all duration-500 flex-col lg:translate-x-0   ${navbar ? 'translate-x-0' : 'translate-x-full'} `}>
            <NavLinks />
     ...
     <a href="https://x.com/NtcodexS?t=JUdUMpHES4-ABv2oCwK8qw&s=09"> <FaXTwitter className='hover:text-white hover:scale-110 transition'/></a>
      ...
      <header
        className={`
          ...
          bg-gradient-to-r from-[#1d2549] hidden via-[#365200] to-[#1d2549]
